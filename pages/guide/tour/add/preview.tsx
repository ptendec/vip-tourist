...
const Main = () => {
  ...
  const { mutate, isLoading: creating } = useMutation(createTour)
    ...
    mutate(
      {
        ...
        profile: data?.id,
        child_price: !existingTour?.child_price
          ...
          <Container className='justify-self-center pt-10 flex flex-col mx-auto min-h-screen'>
            ...
            >
              ...
              <Button
                onClick={create}
                type='submit'
                disabled={!existingTour?.city || creating}
